...
MEDIA_ROOT = utils.get_env(
    "BURL_MEDIA_ROOT", os.path.join(HOME, "var", "burl", "media")
)
STATIC_ROOT = utils.get_env(
    "BURL_STATIC_ROOT", os.path.join(HOME, "share", "burl", "static")
)
